        ...
        <Container maxW="container.xl">
          {props.isPc && (
            <Flex py={{ base: 4 }} px={{ base: 4 }}>
              <Link href={topPagePath.en} fontSize={"sm"}>
                Rust.Tokyo
              </Link>
              <Spacer />
          ...
          {!props.isPc && (
            <Flex py={{ base: 4 }} px={{ base: 4 }}>
              <Stack direction={"row"}>
                <Center>
                  <Link pr={4} href={props.currentPage.ja} fontSize={"sm"}>
                    JP
                  </Link>
                  <Link href={props.currentPage.en} fontSize={"sm"}>
                    EN
      ...
      <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            ...
            >
              <Box>
                <Link href={topPagePath.en} fontSize={"md"} fontWeight={500}>
                  TOP
                </Link>
              </Box>
              <Box>
                <Link href={lineupPagePath.en} fontSize={"md"} fontWeight={500}>
                  LINE UP & SCHEDULE
                </Link>
              </Box>
              <Box>
              ...
              <Box>
                <Link href={cocPagePath.en} fontSize={"md"} fontWeight={500}>
                  CODE OF CONDUCT
                </Link>
              </Box>
            </VStack>
