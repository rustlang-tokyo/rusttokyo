      ...
      <Center>
        <VStack>
          ...
          <SimpleGrid columns={columnSize} spacing={10} pt={{ base: 8 }}>
            <ProfileCard
              pc={props.isPc}
              src="/static/2023/organizers/dorayakikun.png"
            ...
            <ProfileCard
              pc={props.isPc}
              src="/static/2023/organizers/chikoski.jpeg"
              altText="chikoski"
              name="chikoski"
            ...
            <ProfileCard
              pc={props.isPc}
              src="/static/2023/organizers/yuki.png"
              altText="Yuki Toyoda"
              name="Yuki Toyoda"
            ...
            <ProfileCard
              pc={props.isPc}
              src="/static/2023/organizers/akie_mitsukado.jpg"
              altText="Akie Mitsukado"
              name="Akie Mitsukado"
            />
            <ProfileCard
              pc={props.isPc}
              src="/static/2023/organizers/tkato.jpeg"
