...
import type { SpeakerInfo } from "@/constants/2023/lineup/speaker";
import type { SessionListPageTexts } from "@/constants/2023/lineup/text";
import {
  Badge,
  Box,
  Center,
  ...
  return (
    <Box borderWidth={1} p={containerPad} mb={2}>
      ...
      <VStack pb={8}>
        ...
        <TwitterShareButton
          title={`${props.session.title} by ${props.session.speaker[0].name} | Rust Tokyo 2023`}
