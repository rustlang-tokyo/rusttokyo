        ...
        <div className="container">
          <div className="row">
            <div className="col-3 individual-logo">
              <h1>
                <a aria-label="to top page" href="/2019/en/">
                  <Image
                    alt="logo"
            ...
            <div className="col-9">
              <ul className="nav justify-content-end site-nav">
                <li className="nav-item">
                  <a className="nav-link" href="/2019/outline/en/">
                    OUTLINE
                  </a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/2019/sponsorship/en/">
                    SPONSORSHIP
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link active" href="/2019/coc/en/">
                    CODE OF CONDUCT
                  </a>
                </li>
                <li className="nav-item">
