    ...
    <>
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          <h2 className="top">CODE OF CONDUCT</h2>
        </div>
      </div>
      ...
      <div className="container">
        <ul className="nav nav-pills justify-content-end">
          <li className="nav-item">
            <a href="/2019/coc/en/" className="nav-link active">
              EN
            </a>
          </li>
          <li className="nav-item">
            <a href="/2019/coc/" className="nav-link">
              JA
            </a>
          </li>
        </ul>
      ...
      <div id="coc" className="jumbotron-white jumbotron-fluid">
        <div className="container">
          ...
          <p>Mail: rust-tokyo-staff@googlegroups.com</p>
