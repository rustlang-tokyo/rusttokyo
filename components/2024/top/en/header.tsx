        ...
        <DrawerContent>
          ...
          <DrawerBody color="black">
            ...
            >
              ...
              <Box>
                <Link href={lineupPagePath.en} fontSize={"md"} fontWeight={700}>
                  LINE UP & SCHEDULE
                </Link>
              </Box>
              <Box>
                <Link href={accessPagePath.en} fontSize={"md"} fontWeight={700}>
                  ACCESS
                </Link>
              </Box>
              <Box>
              ...
              <Box>
                <Link href={cocPagePath.en} fontSize={"md"} fontWeight={700}>
                  CODE OF CONDUCT
                </Link>
              </Box>
            </VStack>
