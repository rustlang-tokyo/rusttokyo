...
export const sponsors: JobBoardSponsorList = {
  ja: [
    {
      name: "ユニークビジョン株式会社",
      imgSrc: "/static/2024/sponsors/uniquevision.jpg",
      description:
    ...
    {
      name: "AGC株式会社",
      imgSrc: "/static/2024/sponsors/agc.png",
      description:
...
新しい技術やものづくりに関心の強いメンバーが多くドッグフーディングを推奨しています。 少しでも興味がある方はぜひカジュアル面談でお話しましょう。`,
    ...
    {
      name: "株式会社ゆめみ",
      imgSrc: "/static/2024/sponsors/yumemi.png",
      description:
    ...
    {
      name: "株式会社ペイルド",
      imgSrc: "/static/2024/sponsors/paild.png",
      description:
    ...
    {
      name: "株式会社LabBase",
      imgSrc: "/static/2024/sponsors/labbase.png",
      description:
    ...
    {
      name: "パイオニア株式会社",
      imgSrc: "/static/2024/sponsors/pioneer.png",
