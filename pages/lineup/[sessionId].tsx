...
import { LineupDatabaseJa } from "@/constants/2024/lineup/session_description";
import { selectedSessions } from "@/constants/2024/lineup/session_selections";
import { sessionListPageTextsJa } from "@/constants/2024/lineup/text";
...
export default function index(props: { session: SelectedSession }) {
  ...
  return (
    <>
      ...
      <Box bg="vampireBlack.100" pt={16} pb={24}>
